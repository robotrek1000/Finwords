...
export namespace Api {
   ...
   */
  export namespace AcknowledgeLevelResults {
    ...
    export type RequestHeaders = {
      /**
       * UUID v4, уникален на каждое новое намерение клиента (ровно 11 мутаций).
       * Повторный запрос с тем же ключом и тем же телом — replay 200 с сохранённым ответом (write-once + no-op);
       * тот же ключ с другим телом — 409 IDEMPOTENCY_KEY_REUSED. Проверка идемпотентности выполняется
       * до проверки If-Match. Детали хранения replay-сторов (retention, шифрование) — Q-007.
       * @example "e4f8ad5b-d9cb-469f-a165-808677289501"
       */
      "Idempotency-Key": Uuid;
      /**
       * ETag текущего состояния клиента, полученный из заголовка ETag последнего ответа (ровно 10 операций —
       * все мутации, кроме API-001). Сильный непрозрачный quoted-токен ("<opaque>");
       * слабые ETag (W/...) не используются. Устаревший ETag — 409 STATE_VERSION_CONFLICT с payload.currentEtag;
       * клиент повторяет намерение с новым ETag (идемпотентный ключ можно сохранить). Для идемпотентного replay
       * ETag не проверяется. Формат и содержимое токена — внутренняя деталь сервера (MUST NOT документировать
       * алгоритм и поля).
       * @example ""a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6""
       */
      "If-Match": Etag;
    };
    export type ResponseBody = AcknowledgeLevelResultsData;
  }
  ...
  export namespace Bootstrap {
    ...
    export type ResponseBody = BootstrapData;
  }
  ...
  export namespace ClaimReward {
    ...
    export type RequestQuery = {};
    export type RequestBody = ClaimRewardRequest;
    export type RequestHeaders = {
      /**
       * UUID v4, уникален на каждое новое намерение клиента (ровно 11 мутаций).
       * Повторный запрос с тем же ключом и тем же телом — replay 200 с сохранённым ответом (write-once + no-op);
    ...
    export type ResponseBody = ClaimRewardData;
  }
   ...
   * @response `500` `ProcessProblem`
   */
  export namespace ConfirmCampaignCompleteShown {
    export type RequestParams = {};
    export type RequestQuery = {};
    export type RequestBody = never;
    export type RequestHeaders = {
    ...
    export type ResponseBody = ConfirmCampaignCompleteShownData;
  }
   ...
   * @response `500` `ProcessProblem`
   */
  export namespace ConfirmNarrativeShown {
    export type RequestParams = {
      /**
    ...
    export type ResponseBody = ConfirmNarrativeShownData;
  }
   ...
   * @response `500` `ProcessProblem`
   */
  export namespace DismissFeedback {
    export type RequestParams = {
      /**
       * Идентификатор главы (7 глав, BRD CONT-*), UUID v4.
       * @example "2f8fad5b-d9cb-469f-a165-808677289510"
    ...
    export type ResponseBody = DismissFeedbackData;
  }
   ...
   * @response `500` `ProcessProblem`
   */
  export namespace GetAppearanceCatalog {
    export type RequestParams = {};
    export type RequestQuery = {};
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = GetAppearanceCatalogData;
  }
   ...
   * @response `500` `ProcessProblem`
   */
  export namespace GetCurrentState {
    export type RequestParams = {};
    export type RequestQuery = {};
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = GetCurrentStateData;
  }
   ...
   * @response `500` `ProcessProblem`
   */
  export namespace GetLevelResults {
    export type RequestParams = {
      /**
       * Идентификатор уровня (50 уровней, BRD GAME-*), UUID v4.
       * @example "4f8fad5b-d9cb-469f-a165-808677289512"
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = GetLevelResultsData;
  }
   ...
   * @response `500` `ProcessProblem`
   */
  export namespace GetPersonalDictionary {
    export type RequestParams = {};
    export type RequestQuery = {
      /**
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = GetPersonalDictionaryData;
  }
  ...
  export namespace ResumeLevel {
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = ResumeLevelData;
  }
   ...
   * @response `500` `ProcessProblem`
   */
  export namespace SelectAppearance {
    export type RequestParams = {
      /**
    ...
    export type ResponseBody = SelectAppearanceData;
  }
  ...
  export namespace StartLevel {
    ...
    export type ResponseBody = StartLevelData;
  }
  ...
  export namespace SubmitFeedback {
    export type RequestParams = {};
    export type RequestQuery = {};
    export type RequestBody = SubmitFeedbackRequest;
    export type RequestHeaders = {
      /**
       * UUID v4, уникален на каждое новое намерение клиента (ровно 11 мутаций).
       * Повторный запрос с тем же ключом и тем же телом — replay 200 с сохранённым ответом (write-once + no-op);
  ...
  export namespace SubmitRoute {
    ...
    export type RequestQuery = {};
    export type RequestBody = RouteSubmissionRequest;
    export type RequestHeaders = {
      /**
       * UUID v4, уникален на каждое новое намерение клиента (ровно 11 мутаций).
       * Повторный запрос с тем же ключом и тем же телом — replay 200 с сохранённым ответом (write-once + no-op);
    ...
    export type ResponseBody = SubmitRouteData;
  }
  ...
  export namespace UpdateSettings {
    export type RequestParams = {};
    export type RequestQuery = {};
    export type RequestBody = UpdateSettingsRequest;
    export type RequestHeaders = {
      /**
       * UUID v4, уникален на каждое новое намерение клиента (ровно 11 мутаций).
       * Повторный запрос с тем же ключом и тем же телом — replay 200 с сохранённым ответом (write-once + no-op);
  ...
  export namespace UseHint {
    ...
    export type ResponseBody = UseHintData;
  }
}
